...
C:/Users/17735/anaconda3/envs/aiworldengine/python.exe -m PyInstaller --name AIWorldEngine --onedir --windowed --clean --add-data "app/templates;app/templates" --add-data "app/static;app/static" --add-binary "$envPath/Library/bin/libssl-3-x64.dll;." --add-binary "$envPath/Library/bin/libcrypto-3-x64.dll;." --add-binary "$envPath/Library/bin/ffi.dll;." --add-binary "$envPath/Library/bin/sqlite3.dll;." --hidden-import uvicorn.logging --hidden-import uvicorn.loops.auto --hidden-import uvicorn.protocols.http.auto --hidden-import sqlalchemy.sql.default_comparator --hidden-import jinja2 --hidden-import jinja2.ext --hidden-import python_multipart --hidden-import app.services.ai --hidden-import app.services.ai.base --hidden-import app.services.ai.errors --hidden-import app.services.ai.mock_client --hidden-import app.services.ai.openai_compatible_client --hidden-import app.services.ai.model_router --hidden-import app.services.ai.prompt_builder --hidden-import app.services.ai.response_parser --hidden-import app.services.settings_service --hidden-import requests desktop_launcher.py
