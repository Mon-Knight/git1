...
> **当前版本**: v2.0.1 | **GitHub**: [Mon-Knight/git1](https://github.com/Mon-Knight/git1)
>
> **当前阶段**: UI 信息架构调整 — 小说工程核心化，从「世界项目为中心」调整为「小说工程为核心」。已完成全书演化 → 分卷大纲 → 章节大纲 → 正文草稿闭环。

---

## 当前核心能力

> **v2.0.1**: 小说工程是主线核心，世界设定是素材基础，创作资产是上下文支撑，AI 推演是辅助能力。
