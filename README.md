...
> **当前版本**: v2.6.2 | **GitHub**: [Mon-Knight/git1](https://github.com/Mon-Knight/git1)
>
...
> **v2.4.2**: 修复设定库 AI 推演 Character.identity 字段兼容问题。
> **v2.4.1**: 修复设定库 AI 推演 500 错误（数据库 schema 迁移）。
> **v2.4.0**: TXT 小说风格导入、风格画像提取与应用。
