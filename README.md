...
> **当前版本**: v2.1.0 | **GitHub**: [Mon-Knight/git1](https://github.com/Mon-Knight/git1)
>
> **当前阶段**: 正文质量控制 — 新增正文质量检查报告闭环，生成结构化质量报告（综合评分、维度评分、问题列表、修改建议）。

---

## 当前核心能力

> **v2.1.0**: 正文质量检查报告基础版。可基于正文草稿、章节大纲、世界设定和创作资产生成结构化质量检查报告，支持标记当前参考报告和废弃报告。
