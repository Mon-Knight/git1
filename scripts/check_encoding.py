...
FILES = [
    ...
    "docs/project/development-rules.md",
    "docs/project/agent-task-rules.md",
    "docs/project/module-boundaries.md",
    "docs/project/ui-information-architecture.md",
    "docs/project/decision-log.md",
    "docs/project/security-review.md",
    ...
    "docs/design/novel-engineering.md",
    "docs/design/context-assets.md",
    "docs/design/setting-suggestions.md",
    "docs/design/future-interactive-story.md",
