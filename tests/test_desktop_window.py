...
class TestVersionConfig:
    ...
    def test_config_version_is_200(self):
        ...
        assert settings.VERSION == "2.4.2", (
            f"Expected 2.4.2, got {settings.VERSION}"
        )

    def test_desktop_test_version_matches(self):
        # The test_desktop.py test should also reflect 2.4.0
        content = _read_root("tests/test_desktop.py")
        assert "2.4.2" in content, "tests/test_desktop.py missing version 2.4.2"
